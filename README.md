# Home Services Lead Scraper

Extract structured data from [google.com](https://google.com) — Find home-services contractors (plumbers, roofers, electricians, HVAC, landscapers) on Google Maps (google.com/maps) — name, category, address, phone, website, emails, tech stack, and a 0–100 lead score. Built for contractor & SMMA outreach. Geo-accurate, pay per result.

**[Home Services Lead Scraper on Apify →](https://apify.com/blackfalcondata/google-maps-home-services-lead-scraper?fpr=1h3gvi)**
...
```json
{
  ...
  "distanceFromCenterKm": 2.74,
  "address": "450 Industrial Blvd, Austin, TX 78745",
  "neighborhood": null,
...
**[Try Home Services Lead Scraper now — $5 free credit, no credit card →](https://apify.com/blackfalcondata/google-maps-home-services-lead-scraper?fpr=1h3gvi)**
...
See the [actor on Apify](https://apify.com/blackfalcondata/google-maps-home-services-lead-scraper?fpr=1h3gvi) for current pricing.
...
2. Open [Home Services Lead Scraper](https://apify.com/blackfalcondata/google-maps-home-services-lead-scraper?fpr=1h3gvi) and configure your input
3. Click **Start** — export results as JSON, CSV, or Excel
